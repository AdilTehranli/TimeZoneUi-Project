...
const Blog = () => {
  ...
  useEffect(() => {
    axios
      .get("https://localhost:7027/api/Blogs")
      .then((res) => {
        setItem(res.data);
    ...
    <div>
      ...
      <div className="blog">
        <div className="container">
          <div className="row">
            <div className="blog__main about__title col-lg-8 mb-5 mb-lg-0 ">
                ...
                filteredItems.map((product, index) => (
                  <div key={index} className="blog__main__item">
                    <div className="blog__main__image">
                      <img
                        src={`https://localhost:7027//${product.blogImage}`}
                        alt="image"
                        className="rounded-0"
                      />
            ...
            <div className="blog__funktions col-xl-7 col-lg-10 col-md-12 col-sm-10">
